...
```text
โจทย์ข้อนี้ให้หาฤดูจากวันและเดือน รับค่า2ค่าคือเดือนกับวัน จากนั้นเอามาใข้ifมาเช็คว่าเป็นฤดูอะไร และแสดงค่าฤดู
```
...
Step 2:นำค่ามาใช้if ถ้าถึงวันเลยหรือถึงวันที่21ของเดือนที่หาร3ลงตัวจะเปลี่ยนฤดูไปเป็นเดือนถัดไป
Step 3:แสดงค่าฤดู
```
...
```text
เหมือนกับแผนแรกแต่ติดปัญหาpep8นิดหน่อยเพราะใช้ifเยอะเกินไป
```
...
```text
เพราะเป็นช่วงเปลี่ยนผ่านฤดูเหมือนกัน
```
