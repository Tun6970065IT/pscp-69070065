...
```text
จากโจทย์ให้รับ string มา 5 บรรทัด และ ใส่กรอบให้มัน
input:
รับstring มา5 อันและใช้.stripเพื่อตัด" " ออก
output:
stirng 5 อันที่มีกรอบ
```
...
```text
step 1 : สร้าง list ไว้เก็บค่า input()
step 2 : สร้าง ตัวแปร long ไว้เก็บค่าความยาวของตัวอักษร
step 3 : ใช้ loop รับค่า string 5 ตัว และ appendไปในlist และ ตรวจสอบความยาวของตัวอักษร
step 4 : print ขอบบน
step 5: ใช้ loop เพื่อ print ตัวอักษรตามเงื่อนไข
step 6 : print ขอบล่าง
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก แต่พลาดตรง space ระหว่างขอบของตัวอักษร เลยแก้ให้ถูกต้อง
```
...
```text
ลองตามsample testcaseว่าตรงไหม
```
...
```text
ลองว่าถ้ามีตัวเดียวจะเป็นยังไง
...
```text
ช่วยตอนใช้loop printตัวอักษร
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำทุกขั้นยกเว้น ตอนใช้loop printตัวอักษร
```
