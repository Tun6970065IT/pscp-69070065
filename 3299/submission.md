...
```text
อินพุตคือ L (ความหนาของแถบ) กับ N (จำนวนช่องที่ปลูก) และเอาต์พุตคือหมายเลขแถบของช่องสุดท้าย
```
...
```text
ลองหาว่าในแต่ละแถบมีการเพิ่มขึ้นอย่างไร และได้พบว่าในแถบนั้นจะมีการเพิ่มขึ้่นแบบ l ** 2
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก ใช้while loopตรวจสอบว่าในช่องที่กำหนดปลูกได้กี่ต้นถ้ายังไม่ครบก็ปลูกเพิ่มจนครบและจะได้แถวสุดท้าย
```
...
```text
หาสูตรในการหาแต่ละแถวในwhile loopและอื่นๆ
```
