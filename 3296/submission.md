...
```text
รับค่า R G B มา อย่างละ2 และ นำ Rตัวที่1 + Rตัว2 แล้วเอาไป // 2 เพื่อหาค่าเฉลี่ย และ ทำแบบนี้กับอีก2ตัว
```
...
```text
รับสี นำแต่ละสีมาบวกกันแล้วหาค่าเฉลี่ย
```
...
```text
ลองจากsample testcase ว่าตรงไหม
```
